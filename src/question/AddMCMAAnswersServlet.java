...
/**
 * Servlet implementation class AddMCMAAnswersServlet
 */
@WebServlet("/AddMCMAAnswersServlet")
public class AddMCMAAnswersServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddMCMAAnswersServlet() {
        super();
...
System.out.println("request isFinished " + request.getParameter("isFinished"));
		...
		Answer answer = new MultiChoiceMultiAnswerAnswer(-1, answerTexts, numAnswers, score);
		...
		if(request.getParameter("isFinished")==null) request.getRequestDispatcher("MCMAanswer.jsp").forward(request, response);
